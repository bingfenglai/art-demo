...
@Component
@Slf4j
public class RefreshDtpConfigImplWithDataBase extends BaseRefreshDtpConfig implements RefreshDtpConfig {
    ...
    public RefreshDtpConfigImplWithDataBase() {
        super(ConfigSourceTypeEnums.DATABASE);
    }

    @Override
    public ThreadPoolPropertyConfig getDtpConfig() {
        log.info("从数据库当中加载线程池配置");
        return getDtpConfigFromDb();
    ...
    private ThreadPoolPropertyConfig getDtpConfigFromDb() {
        return this.threadPoolPropertyConfig;
    }
