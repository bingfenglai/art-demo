                ...
                <div class="panel panel-default">
                    ...
                    <table id="dataList"
                        ...
                        <c:forEach var="traveller" items="${orders.travellers}" varStatus="vs">
                            ...
                            <tr>
                                <td>
                                    <input type="text" value="${traveller.travellerTypeStr}"
                                           name="travellers[${vs.index }].travelllerType">
                                </td>
                                <td>
                                    <input type="text" size="10" value="${traveller.name }"
                                           name="travellers[${vs.index}].name">
                                </td>
                                <td>
                                    <input type="text" size="10" value="${traveller.sex }"
                                           name="travellers[${vs.index}].sex">
                                </td>
                                <td>
                                    <input type="text" size="20" value="${traveller.phoneNum }"
                                           name="travellers[${vs.index}].phoneNum">
                                </td>
                                <td>
                                    <input type="text" size="15" value="${traveller.credentialsTypeStr}"
                                           value="travellers[${vs.index}].credentlsType">
                                </td>
                                <td>
                                    <input type="text" size="28" value="${traveller.credentialsNum }"
                                           value="travellers[${vs.index}].credentialsNum">
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data text">
                            ...
                            <input type="text" class="form-control" value="${orders.member.nickname }"
                        ...
                        <div class="col-md-4 data text">
                            <input type="text" value="${orders.member.phoneNum}" name="member.phoneNum"
                                   class="form-control">
                        </div>
                ...
                <c:if test="${orders.orderStatus==1}">
                    <div class="panel panel-default">
                        ...
                        <div class="row data-type">
                            ...
                            <div class="col-md-4 data text">在线支付-<input type="text" value="${orders.payTypeStr}"
                                                                        name="payType"></div>

                            <div class="col-md-2 title">金额</div>
                            <div class="col-md-4 data text">￥<input type="text" value="${orders.product.productPrice}"
                                                                    name="product.productPrice"></div>
