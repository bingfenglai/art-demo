...
CREATE
DATABASE /*!32312 IF NOT EXISTS*/`shiro_demo1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert into `resource`(`resource_id`, `resource_name`, `resource_uri`, `resource_farther_id`, `resource_ico_url`,
                       `resource_desc`, `resource_permission_tag`)
values (1, '查询产品权限', '/product/get/list', NULL, NULL, '查询产品记录', 'product:get');
...
values (1, 'xiangbei', 'ff595c47b51b4cf70fddce090f68879e', 'ee575f62-0dda-44f2-b75e-4efef795018f');
...
insert into `user_role`(`id`, `role_id`, `user_id`, `username`)
values (1, 1, 1, 'xiangbei');
