...
CREATE
DATABASE /*!32312 IF NOT EXISTS*/`security_authority` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert into `sys_permission`(`ID`, `permission_NAME`, `permission_url`, `parent_id`)
values (1, '产品', 'product:get', 0);
...
values (4, 'user', '$2a$10$GKm3PsUSwWjDGbDQejRRuuP4I888NKxvKk.bzUm0glD51n4dN6M0K', 1),
       (5, 'admin', '$2a$10$vzJXh6RJk.K4fXehJp7njuLpN/4A.iqeTcxAa2I1P5PLNPe/03lae', 1);
